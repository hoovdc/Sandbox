...
def get_gsheet_data():
    ...
    return habits_tab_data_headers,habits_tab_data, text_quotes, finmkts_tab_data, fit_run_data
...
def process_habits(habits_tab_data_headers, habits_tab_data):
    ...
    #print ("df_heatmap \n", df_heatmap[:10])
    return df_heatmap, df_habit_data_bars, df_habit_data_line_LxD, df_habit_data_wkday_summary, df_habit_data_perhabit_summary
...
def process_fitness(fit_run_data):
    ...
    print("Original DataFrame columns:", df_fit_run.columns)
    ...
    #print headers and first 2 rows of data
