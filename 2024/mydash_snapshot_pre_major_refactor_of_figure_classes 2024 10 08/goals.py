...
def goals_input_to_fig():

    # Load the CSV file in an OS-independent way (different OSes have different path formats)
    file_path = Path('Data') / 'Time Data' / 'Goal Data' / 'Goal, Task, and Time Tree - Structure and Synthetic Data - Data_Summary_Flat.csv'
