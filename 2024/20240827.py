...
fig_hr = px.line(hourly_dataframe, x = 'date', y = 'temperature_2m') #causes error
#fig_hr = px.line(hourly_export, x = 0, y = 1, title = "dark mode bayyybayyyyyy")
fig_hr2 = px.bar(hourly_export, x = 0, y = 1, title = "dark mode bayyybayyyyyy")
fig_day = px.scatter(daily_dataframe, x = 'date', y = 'sunrise')

application = Flask(__name__)
dash_app = dash.Dash(__name__, server = application, url_base_pathname='/dash/',
...
#print out all the routes registered in your Flask app, including where Dash is served.
print("Printing out all routes registered in Flask app:")
