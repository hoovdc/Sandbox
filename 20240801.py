...
def process_habits(habits_tab_data_headers, habits_tab_data, habits_tab_data_full):
    ...
    #select all rows from columns 28 to 36 from the habits tab
    listdata_perhabit_lines_LxD = habits_tab_data_full[0][27:36]
    print(listdata_perhabit_lines_LxD[1:3])
    ...
    df_perhabit_lines_LxD = pd.DataFrame(listdata_perhabit_lines_LxD[1:], columns=listdata_perhabit_lines_LxD[0])
    ...
    return df_heatmap, df_habit_data_bars, df_habit_data_line_LxD, df_perhabit_lines_LxD, \
           df_habit_data_wkday_summary, df_habit_data_perhabit_summary
